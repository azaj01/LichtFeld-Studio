...
class LayoutContext:
    def __enter__(self) -> LayoutContext:
...
class UILayout:
    ...
    def row(self) -> LayoutContext:
        """Create a horizontal row layout context manager"""

    def column(self) -> LayoutContext:
        """Create a vertical column layout context manager"""

    def split(self, factor: float = 0.5) -> LayoutContext:
        """Create a split layout context manager with given factor"""
